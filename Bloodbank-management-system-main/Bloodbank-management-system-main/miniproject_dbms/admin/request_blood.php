...
<body>
    ...
    <form class="form" action="" method="post">
        ...
        <input type="text" class="login-input" name="reci_name" placeholder="Recipient name" value="<?php echo isset($prefill_name) ? htmlspecialchars($prefill_name) : ''; ?>" />
        <input type="text" class="login-input" name="reci_bgrp" placeholder="Recipient bgrp" required />
        <input type="submit" name="submit_request" value="Register" class="btn btn-dark btn-lg register-button">
    ...
    <script>
        (function () {
            ...
            const nameEl = document.querySelector('input[name="reci_name"]');
