...
INSERT INTO `blood_request` (`id`, `reci_name`, `reci_bgrp`, `reci_id`) VALUES
(30, 'Allen', 'AB+', 5),
(32, 'pranavvv', 'O+', 8);
...
--
DELIMITER $$
CREATE TRIGGER `delete_blood_stock1` AFTER DELETE ON `blood_request` FOR EACH ROW UPDATE blood_stock set b_qnty = b_qnty - 1 WHERE b_grp = old.reci_bgrp
$$
DELIMITER ;
...
INSERT INTO `donor` (`D_id`, `D_name`, `D_age`, `D_sex`, `D_phno`, `D_bgrp`, `rdate`) VALUES
(5, 'manoranjan', 20, 'male', '7878798989', 'AB+', '2021-09-23'),
(6, 'parth', 20, 'male', '8787699087', 'A+', '2021-10-08'),
(7, 'tim', 33, 'male', '8765498987', 'A+', '2021-10-08');
...
INSERT INTO `recipient` (`reci_id`, `reci_name`, `reci_age`, `reci_sex`, `reci_phno`, `reci_reg_date`) VALUES
(4, 'don', 55, 'Male', '6767589897', '2021-10-02'),
(5, 'Allen', 25, 'Female', '9987899876', '2021-10-02'),
(7, 'Mill', 44, '23', '8878799897', '2021-10-08'),
(8, 'pranavvv', 21, 'male', '1234567891', '2021-10-09'),
(11, 'Singhh', 22, 'Male', '6767589897', '2021-10-09');
